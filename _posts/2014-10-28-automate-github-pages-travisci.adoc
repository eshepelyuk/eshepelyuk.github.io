...
The only precondition is that you should have `Jekyll` project properly configured, using http://bundler.io/[Bundler^] and you can run the site locally using command
