...
excerpt: |
    ...
    This makes it hard for Java-boys (as me) to jump into.
    So purpose of this short tutorial is to explain in few easy steps how to start with JS MVC framework `AngularJS` and `CoffeeScript` on `Grails`.
---
