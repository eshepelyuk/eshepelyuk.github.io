...
* Responsibilities
** Organizing build process using Gradle, defining plaform release flow
...
* Responsibilities
** Team leading tasks
** Design and implementation of system architecture targetting best performance and scalability results
...
* Role: Developer. 
* Responsibilities: Сreating reusable components and reports for UI.
