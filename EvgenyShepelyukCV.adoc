...
* Responsibilities
** Creating build process using Gradle, defining plaform release flow
** Developing and supporting Liferay Portlets
** Injecting TDD practices and tools
** Colalborating with architects on defining platform components
...
** Architectural solution and their technical implementation
** Adoption and injection of Agile engineering practices
...
** Architectural solution creation and their technical implementation
...
** Maintaining continuos integration
** Release preperation and delivery support
...
** Creating screens for GPS actions as speedometer, compass, lap counter etc
...
* Responsibilities
** Team leading tasks (communication, estimation, control, planning, code review etc.) 
** Creating architecture and developement
...
** DB structure creation, analysis and optimization
** DB process improvements to achieve extra performance 
...
** Development bridges between system core and external service providers using custom XML/ HTTP communications and Web Services (WSDL)
** Integrating with Asterisk and providing IVR solutions for system
** UI structure and analysis
...
* Role: Developer. 
* Responsibilities
** UI reporting creation
** Creating reusable components for UI development
...
* Role: Developer.
* Responsibilities
** Data exchange between cell phone and server. 
** UI development
...
** Communication with book keeping customer’s team
