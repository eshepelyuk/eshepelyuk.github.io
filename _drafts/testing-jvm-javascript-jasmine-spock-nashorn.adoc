...
The feature allows to embed arbitrary language into file created in another language. 
...
And then again, `Jasmine` is my personal preference. With additional work code could be modified to leverage `Mocha`, `QUnit` and so on.
