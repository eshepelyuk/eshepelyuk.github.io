...
:sourcedir: https://github.com/eshepelyuk/CodeForBlog/tree/master/TestMeIfYouCanNashornSpock/src
...
----
include::{sourcedir}/main/java/ua/eshepelyuk/blog/nashorn/JavaScriptRunner.java[]
----
