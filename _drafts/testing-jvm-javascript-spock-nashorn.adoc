...
[source,java]
----
include::http://raw.githubusercontent.com/eshepelyuk/CodeForBlog/master/TestMeIfYouCanNashornSpock/src/main/java/ua/eshepelyuk/blog/nashorn/JavaScriptRunner.java[QWE]
----
